...
test("Should return empty string if it does not find the #experience section", () => {
  // Arrange
  const value = load(`
    <html>
        <body>
  ...
  const result = "<html><head></head><body></body></html>"; // Cheerio always wraps up the contents in HTML, HEAD, and BODY tags.
