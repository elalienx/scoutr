...
import linkedInAuth from "./routes/linkedInAuth";
...
async function initializeServer(port: number) {
  ...
  app.post("/api/linkedin-auth", (request, response) => linkedInAuth(request, response));

  // Serve static image (to see the images generated by the auth)
