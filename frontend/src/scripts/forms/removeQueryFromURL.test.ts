...
describe("Correctly parse links", () => {
...
describe("Handle error cases", () => {
  ...
  test("Passing a broken URL does not crash, just returns the text as it is", () => {
    // Arrange
    const value = ".com/pepito"; // missing https:// and even the domain name
    const result = ".com/pepito";
