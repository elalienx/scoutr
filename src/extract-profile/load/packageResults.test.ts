...
test("Best scenario, all candidates were parsed and there is not errors", () => {
  ...
  const errorReports: ErrorReport[] = [
    { url: "linked.com/eduardo", severity: 0, message: "No problems found" },
    { url: "linked.com/alexia", severity: 0, message: "No problems found" },
  ];
...
test("Warning scenario, all candidates were parsed but there are some warnings", () => {
  ...
  const errorReports: ErrorReport[] = [
    { url: "linked.com/eduardo", severity: 1, message: "Missing candidate_job_title" },
    { url: "linked.com/alexia", severity: 0, message: "No problems found" },
  ];
  const result: ResultsAPI = {
    status: 200,
    ...
    message: [{ url: "linked.com/eduardo", severity: 1, message: "Missing candidate_job_title" }],
  };
...
test("Edge case scenario, some candidate was not parsed", () => {
  ...
  const errorReports: ErrorReport[] = [
    { url: "linked.com/eduardo", severity: 0, message: "No problems found" },
    { url: "linked.com/alexia", severity: 2, message: "Missing all fields" },
  ];
  const result: ResultsAPI = {
    status: 200,
    data: [{ id: 1, name: "Eduardo", title: "Sample job title" }],
    message: [{ url: "linked.com/alexia", severity: 2, message: "Missing all fields" }],
  };
...
test("Bad scenario, no candidates were parsed", () => {
  ...
  const errorReports: ErrorReport[] = [
    { url: "linked.com/eduardo", severity: 2, message: "Missing all fields" },
    { url: "linked.com/alexia", severity: 2, message: "Missing all fields" },
  ];
  const result: ResultsAPI = {
    status: 500,
